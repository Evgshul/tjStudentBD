...
2. Add following snippet there:
        ...
        <datasource jndi-name="java:jboss/datasources/tjStudentBDDataSource" pool-name="tjStudentBDDataSource" enabled="true" use-java-context="true">
            <connection-url>jdbc:h2:~/tjStudentBDDatabase;AUTO_SERVER=TRUE</connection-url>
            <driver>h2</driver>
            <security>
...
2. Add following snippet there:
        ...
        <security-domain name="tjStudentBDSecurityDomain" cache-type="default">
            <authentication>
                <login-module code="Database" flag="required">
                    <module-option name="dsJndiName" value="java:jboss/datasources/tjStudentBDDataSource"/>
